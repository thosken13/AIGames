...
class NNAgent:
    ...
    def buildModel(self):
        ...
        summaryWriter = tf.summary.FileWriter("tensorboardFiles"+str(time.time()), graph=tf.get_default_graph())
    ...
    def test(self):
        ...
        opt, summaryString = self.session.run([self.netDict["optimizer"], self.netDict["summary"]], 
